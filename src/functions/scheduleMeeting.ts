...
async function sendMeetingEmail(clientEmail: string, clientName: string, meetingDetails: any): Promise<void> {
  try {
...
export async function scheduleMeeting(
  ...
  try {
    ...
    const useVideoConference = location.toLowerCase().includes("google meet") || location.toLowerCase().includes("zoom")
...
Automatically scheduled by LISA.
    ...
    try {
      ...
      logger.error("Failed to send meeting email, but meeting was created:", emailError)
    }
